...
@Component({
  selector: 'mr-category-general-info',
  templateUrl: './mr-category-general-info.component.html',
  styleUrls: ['./mr-category-general-info.component.scss']
})
export class MrCategoryGeneralInfoComponent extends BaseComponent implements OnInit, OnChanges {
 //#region Public Variables
  ...
  public itemName: string = "Material Category";
  //#endregion
  ...
  public onConfirmDelete(_self: any, params: any) {
    _self.generalInfoService.deleteMaterialStockCategory(params).subscribe((resp: any) => {
  ...
  onAddItem() {
    ...
    if( this.addItemForm.valid ) {
      ...
      this.generalInfoService.saveOrUpdateMaterialStockCategory(params).subscribe((resp:any)=>{      
  ...
  private getItemList() {
    ...
    this.generalInfoService.getMaterialStockCategoryList(params).subscribe((resp:any)=>{      
      this.itemList = resp["materialCategories"];
    });
  }
  ...
  private initializeForm(data: any) {
    this.addItemForm = new FormGroup({
      materialCategoryId : new FormControl((null != data ? data.materialCategoryId : '')),
      materialCategory : new FormControl((null != data ? data.materialCategory : ''), Validators.required),
  ...
  private getPreparedParams(submitData: any) {
    ...
    let params : {[k : string]: any}= {
      materialCategory : submitData.materialCategory,
      description : submitData.description
    }

    if(this.isEdit) {
      params.materialCategoryId = submitData.materialCategoryId
    }
