...
@Component({
  selector: 'cr-customerjobnature-general-info',
  templateUrl: './cr-customerjobnature-general-info.component.html',
  styleUrls: ['./cr-customerjobnature-general-info.component.scss']
})
export class CrCustomerJobNatureGeneralInfoComponent extends BaseComponent implements OnInit, OnChanges {
 //#region Public Variables
  ...
  public itemName: string = "Nature of Job";
  //#endregion
  ...
  public onConfirmDelete(_self: any, params: any) {
    _self.generalInfoService.deleteCustomerJobNature(params).subscribe((resp: any) => {
  ...
  onAddItem() {
    ...
    if( this.addItemForm.valid ) {
      ...
      this.generalInfoService.saveOrUpdateCustomerJobNature(params).subscribe((resp:any)=>{      
  ...
  private getItemList() {
    let params = {}
    this.generalInfoService.getCustomerJobNatureList(params).subscribe((resp:any)=>{      
