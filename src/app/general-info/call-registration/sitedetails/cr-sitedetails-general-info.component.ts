...
@Component({
  selector: 'cr-sitedetails-general-info',
  templateUrl: './cr-sitedetails-general-info.component.html',
  styleUrls: ['./cr-sitedetails-general-info.component.scss']
})
export class CrSiteDetailsGeneralInfoComponent extends BaseComponent implements OnInit, OnChanges {
 //#region Public Variables
  ...
  public itemName: string = "Site Details";
  //#endregion
  ...
  public onConfirmDelete(_self: any, params: any) {
    _self.generalInfoService.deleteCustomerSiteDetailsById(params).subscribe((resp: any) => {
  ...
  onAddItem() {
    ...
    if( this.addItemForm.valid ) {
      ...
      this.generalInfoService.saveOrUpdateCustomerSiteDetails(params).subscribe((resp:any)=>{      
  ...
  private getItemList() {
    let params = {}
    this.generalInfoService.getAllCustomerSiteDetails(params).subscribe((resp:any)=>{      
      this.itemList = resp["customerSiteDetails"];
    });
  }
  ...
  private initializeForm(data: any) {
    this.addItemForm = new FormGroup({
      siteId : new FormControl((null != data ? data.siteId : '')),
      siteName : new FormControl((null != data ? data.siteName : ''), Validators.required),
      others : new FormControl((null != data ? data.others : ''))
    });
  }
  ...
  private getPreparedParams(submitData: any) {
    ...
    let params : {[k : string]: any}= {
      ...
      others : submitData.others
    }

    if(this.isEdit) {
      params.siteId = submitData.siteId
    }
